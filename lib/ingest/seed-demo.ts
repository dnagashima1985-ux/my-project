...
const DEMO_EQ = [
  {
    ...
    evidence: {
      self_awareness:  ['https://www.aftonbladet.se/sport/fotboll/allsvenskan | Post-match interview vs Djurgården (2024-04-18, Aftonbladet) — credited teammates, did not deflect criticism after 1-0 loss'],
      self_regulation: ['https://www.allsvenskan.se/spelare/marcus-lindstrom | No disciplinary sanctions across 28 appearances (Allsvenskan official records 2024)'],
      motivation:      ['https://www.fotbollskanalen.se/allsvenskan | Pre-season interview (2024-01-30, Fotbollskanalen) — expressed ambition to reach European level within two years'],
      empathy:         ['https://www.svtsport.se/fotboll | Captain\'s statement after Hammarby derby (2024-05-05, SVT Sport) — publicly praised young substitute\'s impact'],
      social_skills:   ['https://www.aikfotboll.se/nyheter | Teammate quotes in squad profile (2024-08-12, AIK official) — described as "calm head in tense moments"'],
    },
    flags: {},
  },
  {
    ...
    evidence: {
      self_awareness:  ['https://www.sponichi.co.jp/soccer | Post-match quotes after J1 loss (2024-06-22, Sponichi) — acknowledged personal positioning error'],
      self_regulation: ['https://www.jleague.jp/player | Zero bookings in 30 J1 League appearances (J.League official stats 2024)'],
      motivation:      ['https://www.goal.com/jp | Interview on European ambitions (2024-02-14, Goal Japan) — detailed training improvements made in off-season'],
      empathy:         ['https://www.nhk.or.jp/sports | Gamba Osaka team interview (2024-09-01, NHK Sports) — praised youth academy integration'],
      social_skills:   ['https://sportiva.shueisha.co.jp/soccer | Three separate teammates cited him as team leader in end-of-season awards coverage (2024-12-01, Sportiva)'],
    },
    flags: {},
  },
  {
    ...
    evidence: {
      self_awareness:  ['https://www.record.pt/futebol | Post-match comment after Porto loss (2024-10-03, Record) — acknowledged missed chances but attributed some to goalkeeper'],
      self_regulation: ['https://www.zerozero.pt/jogo | Yellow card for dissent vs Sporting CP (2024-11-09, Zerozero) — disputed referee decision publicly'],
      motivation:      ['https://www.abola.pt/braga | Pre-season interview (2024-01-20, A Bola) — stated goal of 20 league goals'],
      empathy:         [],
      social_skills:   ['https://www.scbraga.pt/noticias | Described as "professional" by manager in press conference (2024-07-15, SC Braga official)'],
    },
    flags: {
  ...
  },
  {
    ...
    evidence: {
      self_awareness:  ['https://www.marca.com/futbol/alaves | Post-red card interview (2024-03-17, Marca) — disputed the decision rather than accepting responsibility'],
      self_regulation: ['https://www.laliga.com/stats | Red card vs Villarreal (2024-03-14, La Liga official) — straight red for violent conduct; later reduced on appeal'],
      motivation:      ['https://www.deportivoalaves.com/noticias | Training ground profile (2024-08-05, Alavés official) — described as dedicated and first to arrive'],
      empathy:         [],
