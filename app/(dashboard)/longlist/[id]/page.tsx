...
import { ArrowLeft, Bookmark, FileText, Download } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <a
          href={`/api/longlist/${id}/csv`}
          className="flex items-center gap-2 text-sm bg-gray-800 hover:bg-gray-700 text-gray-300 px-3 py-2 rounded-lg transition-colors"
        >
          <Download size={14} />
          CSV
        </a>
